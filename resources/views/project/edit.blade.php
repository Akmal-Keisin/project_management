                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url("project/edit/$project->id") }}">{{ $project->name }}</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="align-items-center mb-4">
                            <form action="{{ url("project/$project->id") }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Project Management System" value="{{ $project->name }}">
                                    @if($errors->has('name')) <span class="text-danger">{{ $errors->first('name') }}</span> @endif
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Project Description :</label>
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="App to manage some project with other people">{{ $project->description }}</textarea>
                                ...
                                <div class="mb-3 d-flex">
                                    <div class="mr-3">
                                        ...
                                        <input type="date" name="date_start" id="date_start" class="form-control" value="{{ $project->date_start }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="project_manager" class="form-control" placeholder="Project Manager Id" value="{{ $project->created_by }}">
